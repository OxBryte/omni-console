...
function renderNetworkDetails() {
  ...
  container.innerHTML = `
    <div class="oc-detail-section">
      <div class="oc-detail-header">General</div>
    ...
    <div class="oc-detail-section">
      <div class="oc-detail-header">Request Headers</div>
      <div class="oc-detail-body">${headersHtml}</div>
    </div>
    
    <div class="oc-detail-section">
      <div class="oc-detail-header">Request Payload</div>
      <div class="oc-detail-body" style="font-family:monospace; font-size:11px;">${reqBodyHtml}</div>
    </div>
    
    <div class="oc-detail-section">
      <div class="oc-detail-header">Response Headers</div>
      <div class="oc-detail-body">${respHeadersHtml}</div>
    </div>
    
    <div class="oc-detail-section">
      <div class="oc-detail-header">Response Body</div>
